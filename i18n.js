...
(function (root, factory) {
  ...
  var STRINGS = {
    en: {
      ...
      'entry.stint': 'Stint limit',
      'entry.stintHint': 'Optional. The longest you may run before stopping — a regulation, a driver swap, or your own plan. Blank means the tank is the only limit.',
      ...
      'load.multiStintNoTank': 'Total for the race across {stints} stints, so it is not a single fill. Start with {start} L.',
      ...
      'strat.overStint': 'Over stint',
      'strat.fastestViable': 'Fastest viable',
      'strat.viable': 'Viable',
      'strat.exceedsTank': 'Exceeds tank',
      'strat.exceedsStint': 'Exceeds stint limit',
      'strat.overLimit': 'Over a limit',
      'strat.needTank': 'Enter your tank capacity — or a stint limit — to compare pit strategies.',
      ...
      'strat.noneFitLimits': 'No strategy fits these limits. Even split across {n} stints, the longest still runs {laps} {lapWord} ({time}) on {max} L. Check the stint limit, the tank capacity and the fuel figure.',
      ...
      'strat.oneStintFree': 'The whole race fits inside a single stint.',
      'strat.fewestStint': '{stops} {stopWord} is the fewest that keeps every stint inside {min} min.',
      'strat.fewestBoth': '{stops} {stopWord} is the fewest that fits both a {tank} L tank and a {min} min stint.',
      'strat.stintCap': 'A {min} min stint limit is {laps} {lapWord} at {lap}, so anything longer is ruled out.',
      ...
      'strat.truncated': 'Strategies with fewer stops are omitted: none of them fit.',
      'strat.stop': 'stop',
      ...
      'err.stintTooShort': 'The stint limit is shorter than one lap ({lap}).'
    },
    ...
    ms: {
      ...
      'entry.stint': 'Had stint',
      'entry.stintHint': 'Pilihan. Selama mana anda boleh berada di trek sebelum henti — peraturan, tukar pemandu, atau rancangan anda sendiri. Kosong bermakna tangki sahaja yang menghadkan.',
      ...
      'load.multiStintNoTank': 'Jumlah untuk seluruh perlumbaan merentas {stints} stint, jadi ini bukan satu isian. Mula dengan {start} L.',
      ...
      'strat.overStint': 'Lebih stint',
      'strat.fastestViable': 'Terpantas & muat',
      'strat.viable': 'Muat',
      'strat.exceedsTank': 'Lebih tangki',
      'strat.exceedsStint': 'Lebih had stint',
      'strat.overLimit': 'Lebih had',
      'strat.needTank': 'Masukkan kapasiti tangki — atau had stint — untuk banding strategi pit.',
      ...
      'strat.noneFitLimits': 'Tiada strategi muat had ini. Walaupun dibahagi sama rata kepada {n} stint, yang terpanjang masih {laps} {lapWord} ({time}) dan perlukan {max} L. Semak had stint, kapasiti tangki dan jumlah minyak.',
      ...
      'strat.oneStintFree': 'Seluruh perlumbaan muat dalam satu stint.',
      'strat.fewestStint': '{stops} {stopWord} ialah paling sedikit yang mengekalkan setiap stint dalam {min} min.',
      'strat.fewestBoth': '{stops} {stopWord} ialah paling sedikit yang muat kedua-dua tangki {tank} L dan stint {min} min.',
      'strat.stintCap': 'Had stint {min} min bersamaan {laps} {lapWord} pada {lap}, jadi apa-apa yang lebih panjang tidak diambil kira.',
      ...
      'strat.truncated': 'Strategi dengan henti lebih sedikit tidak ditunjuk: tiada satu pun muat.',
      'strat.stop': 'henti',
      ...
      'err.stintTooShort': 'Had stint lebih pendek daripada satu pusingan ({lap}).'
    }
  };
